   ...
   public class UiService:IUiService
    {
        ...
        public void ChangeInfo(string info,User currentUser)
        {
            ...
            while (changeInfo)
            {
                ...
                {
                    case "first name": 
                changeInfo = Database.Database._userService.ChangeFirstName(currentUser.Id, oldInfo, newInfo);
                        break;
                    case "last name":
                changeInfo = Database.Database._userService.ChangeLastName(currentUser.Id, oldInfo, newInfo);
                        break;
                    case "password":
                changeInfo = Database.Database._userService.ChangePassword(currentUser.Id, oldInfo, newInfo);
                        break;
                }
            }
