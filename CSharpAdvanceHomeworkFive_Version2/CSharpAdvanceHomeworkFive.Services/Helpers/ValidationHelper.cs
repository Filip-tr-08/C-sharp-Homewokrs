                ...
                switch (answer)
                {
                    case "y":
                        ...
                        while (!correctPassword)
                        {
                            ...
                            if (password == Database.Database._userService.FirstOrDefaultUser(userName).Password)
                            {
                                Database.Database._userService.FirstOrDefaultUser(userName).userStatus = UserStatus.Active;
