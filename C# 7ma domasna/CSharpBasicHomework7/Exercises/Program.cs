        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                else if (option == 2)
                {
                    ...
                    Console.WriteLine("What is your favourite genre");
                    string favouriteGenre = Console.ReadLine();
                    bool flag = true;
                    foreach (Genre genre in Enum.GetValues(typeof(Genre)))
                    {
                        if (favouriteGenre.ToLower() == genre.ToString().ToLower())
                        {
                            flag = true;
                            break;
                        }
                    ...
                    if (flag)
                    {
                        List<Movie> moviesByGenre = (currentCinema.ListOfMovies.Where(m => m.Genre.ToString().ToLower() == favouriteGenre.ToLower())).ToList();
                    ...
                    {
                        throw new Exception("There is not any genre like that");
                    }
                }
                else
                {
